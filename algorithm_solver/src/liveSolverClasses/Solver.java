...
public class Solver {
    ...
    private int nullWindow(Position p, int alpha) {
        ...
        // We store upper bound evals as (eval - essentialClasses.Position.MIN_SCORE + 1)
        // We store lower bound evals as (eval + essentialClasses.Position.MAX_SCORE - 2*essentialClasses.Position.MIN_SCORE + 2)
        ...
        // We go through in reverse order because essentialClasses.MoveSorter is a stack in the case of ties
        ...
        // Iterate through each move in the essentialClasses.MoveSorter
