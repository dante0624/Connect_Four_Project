package liveSolverClasses;// Store each entry in the table as a long (64 bits, 8 bytes), within a massive array
...
public class TranspositionTable {
    ...
    public TranspositionTable(int[] initialKeys, byte[] initialEvals) {
        keys = initialKeys;
        evals = initialEvals;
    }
